...
const injectionPatterns = [
  ...
  /system prompt/i,
  /say .* approved/i,
  /(?:ask for|share|provide).*(?:payment codes?|full bank numbers?|bank numbers?|full ssn|ssn|access codes?|door codes?|entry codes?|verification codes?|passwords?|pins?)/i
];
