...
const restrictedIdentifierPatterns = [
  ...
  {
    pattern:
      /\b(?:[Ff]ull\s+[Nn]ame|[Ss]urvivor\s+[Nn]ame|[Aa]pplicant\s+[Nn]ame|[Hh]ousehold\s+[Mm]ember\s+[Nn]ame|[Cc]ase\s+[Ww]orker\s+[Nn]ame|[Tt]enant\s+[Nn]ame|[Ll]andlord\s+[Nn]ame)\s*[:#-]?\s*[A-Z][A-Za-z.'-]+(?:\s+[A-Z][A-Za-z.'-]+){1,3}\b/g,
