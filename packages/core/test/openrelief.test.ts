...
describe("OpenRelief domain core", () => {
  ...
  it("routes legal-action advice in uploaded letters to human review", () => {
    const lines = [
      "You should sue FEMA and argue negligence in your appeal.",
      "File a lawsuit against FEMA if they deny the appeal.",
      "Take FEMA to court if the appeal is denied.",
      "File in federal court and demand damages from FEMA.",
      "Threaten FEMA with legal action if the appeal deadline is close."
    ];
  ...
  it("routes completed-submission claims in uploaded letters to human review", () => {
    const lines = [
      "OpenRelief submitted your FEMA application.",
      "OpenRelief has submitted your FEMA claim.",
      "We filed your FEMA appeal for you.",
      "This tool delivered your appeal to FEMA.",
      "Your FEMA application was submitted by OpenRelief.",
      "Your claim was filed by our team."
    ];
  ...
  it("does not treat ordinary submission wording as completed-submission injection", () => {
    const lines = [
      "OpenRelief does not submit applications for you.",
      "This app helps organize paperwork for local export.",
      "Submit your appeal by August 15, 2026.",
      "FEMA says your application was submitted before the deadline.",
      "The agency submitted your application before the deadline."
    ];
  ...
  it("redacts tax identifiers with stacked punctuation separators", () => {
    const redacted = redactRestrictedIdentifiers(
      "ITIN #: 912701234 and EIN #: 12-3456789 should not stay in local text."
    );
  ...
  it("redacts property manager names", () => {
    const redacted = redactRestrictedIdentifiers("Property manager name: Dana Ross should not stay in local text.");

    expect(redacted).not.toContain("Dana Ross");
    expect(redacted).toContain("[name removed]");
  });

  it("redacts property manager label names", () => {
    const redacted = redactRestrictedIdentifiers("Property manager: Dana Ross should not stay in local text.");
  ...
  it("redacts expanded housing identifiers with stacked punctuation separators", () => {
    const redacted = redactRestrictedIdentifiers(
  ...
  it("detects unsafe immigration-sensitive instructions as injection warnings", () => {
    const lines = [
  ...
  it("does not treat immigration-sensitive cautions as unsafe instructions", () => {
    const lines = [
  ...
  it("detects known deadline field as deadline risk", () => {
    const flags = detectRiskFlags("Deadline if known: Tomorrow");
  ...
  it("exports local packet text with safety boundary and sources", () => {
    ...
    expect(exported).toContain("Requested items\n- proof of occupancy");
