...
const requestCases = [
  ...
  buildCase({
    id: "ca-wildfire-rfi-private-access-records",
    title: "Request for private access records",
    lines: [
      "FEMA Request for Information",
      "Additional information is needed before a decision can be made.",
  ...
  buildCase({
    id: "ca-wildfire-rfi-hazard-mitigation-records",
    title: "Request for hazard mitigation records",
    lines: [
      "FEMA Request for Information",
      "Additional information is needed before a decision can be made.",
  ...
  buildCase({
    id: "ca-wildfire-rfi-displacement-assistance-records",
    title: "Request for displacement assistance records",
    lines: [
      "FEMA Request for Information",
      "Additional information is needed before a decision can be made.",
  ...
  buildCase({
    id: "ca-wildfire-rfi-continued-housing-assistance-records",
    title: "Request for continued housing assistance records",
    lines: [
      "FEMA Request for Information",
      "Additional information is needed before a decision can be made.",
